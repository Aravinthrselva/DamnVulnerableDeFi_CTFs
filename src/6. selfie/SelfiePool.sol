...
You start with no DVT tokens in balance, 
and the pool has 1.5 million. 
...
// allows only the governance contract to call a certain function
...
// assigns the token & governance contract addresses
...
// returns the max tokens available in this contract
...
// function that gives out flash loan
...
// transfer all tokens from this contract to the receiver mentioned
